...
const marketplaceSnapshotRows = [
  {
    ...
    baseIncomeMps: 27.5,
    starPetsCount: 14,
    starPetsMedianUsd: 7.1,
    eldoradoCount: 15,
    eldoradoSellers: 15,
    eldoradoMedianUsd: 6.99,
    spreadPercent: 1.6,
    consensusUsd: 7.04,
  },
  {
    ...
    baseIncomeMps: 1.5,
    starPetsCount: 6,
    starPetsMedianUsd: 0.835,
    eldoradoCount: 9,
    eldoradoSellers: 9,
    eldoradoMedianUsd: 0.82,
    spreadPercent: 1.8,
    consensusUsd: 0.83,
  },
  {
    ...
    baseIncomeMps: 23.5,
    starPetsCount: 4,
    starPetsMedianUsd: 1.53,
    eldoradoCount: 11,
    eldoradoSellers: 11,
    eldoradoMedianUsd: 1.5,
    spreadPercent: 2,
    consensusUsd: 1.52,
  },
  {
    ...
    baseIncomeMps: 30,
    starPetsCount: 7,
    starPetsMedianUsd: 1.33,
    eldoradoCount: 11,
    eldoradoSellers: 11,
    eldoradoMedianUsd: 1.3,
    spreadPercent: 2.3,
    consensusUsd: 1.31,
  },
  {
    ...
    baseIncomeMps: 200,
    starPetsCount: 5,
    starPetsMedianUsd: 59.06,
    eldoradoCount: 15,
    eldoradoSellers: 13,
    eldoradoMedianUsd: 56.9,
    spreadPercent: 3.8,
    consensusUsd: 57.98,
  },
  {
    ...
    baseIncomeMps: 42.5,
    starPetsCount: 4,
    starPetsMedianUsd: 19.035,
    eldoradoCount: 14,
    eldoradoSellers: 13,
    eldoradoMedianUsd: 19.995,
    spreadPercent: 5,
    consensusUsd: 19.52,
  },
  {
  ...
  },
  {
    ...
    baseIncomeMps: 145,
    starPetsCount: 5,
    starPetsMedianUsd: 20,
    eldoradoCount: 9,
    eldoradoSellers: 9,
    eldoradoMedianUsd: 18,
    spreadPercent: 11.1,
    consensusUsd: 19,
  },
  {
    ...
    baseIncomeMps: 140,
    starPetsCount: 10,
    starPetsMedianUsd: 5.31,
    eldoradoCount: 10,
    eldoradoSellers: 10,
    eldoradoMedianUsd: 4.725,
    spreadPercent: 12.4,
    consensusUsd: 5.02,
  },
  {
...
export const updates: ValueUpdate[] = [
  {
    id: "verified-marketplace-snapshot-2026-07-19",
    date: "2026-07-19",
    title: "Default marketplace prices refreshed",
    summary:
      "Rechecked the full ten-item calculator set against current StarPets and Eldorado listings. Three previous items still qualified, and seven were replaced after failing the current evidence rules.",
    changes: [
      {
        item: "USD marketplace asking prices",
        type: "Note",
        note: "Refreshed all ten source-balanced prices. Every retained item still has at least three listings per source, at least three distinct Eldorado sellers, an exact Default/M/s match, and no more than 15% median spread.",
      },
      {
        item: "Previous snapshot",
        type: "Note",
        note: "Removed five items whose source medians diverged beyond 15% and two items with no current StarPets Default inventory. Added seven qualifying replacements.",
      },
      {
        item: "Calculator guidance",
        type: "Note",
        note: "Clarified the empty offer state so users are told to select an item and use Add instead of seeing a dead-end message.",
      },
    ],
  },
  {
